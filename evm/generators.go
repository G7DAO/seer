...
// TODO:
// - [ ] Working CLI generation for deployment, calls, transactions
// - [ ] Generate header comment (explaining that code is generated by waggle, etc.)
// - [ ] Working CLI generation for event crawling
