...
from models.abstract_labels import Base as LabelsBase

target_metadata = LabelsBase.metadata
...
import_models("moonstreamdbv3.models")
...
model_classes = get_model_classes(LabelsBase)
