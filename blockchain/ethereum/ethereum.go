...
func (c *Client) ParseBlocksAndTransactions(from, to *big.Int, debug bool, maxRequests int) ([]*EthereumBlock, []*EthereumTransaction, error) {
	...
	var parsedTransactions []*EthereumTransaction
