...
type SingleTransaction struct {
	...
	TransactionIndex     int64  `protobuf:"varint,11,opt,name=transaction_index,json=transactionIndex,proto3" json:"transaction_index,omitempty"`
	...
	IndexedAt            int64  `protobuf:"varint,14,opt,name=indexed_at,json=indexedAt,proto3" json:"indexed_at,omitempty"`                // using int64 to represent timestamp
	BlockTimestamp       int64  `protobuf:"varint,15,opt,name=block_timestamp,json=blockTimestamp,proto3" json:"block_timestamp,omitempty"` // using int64 to represent timestam
}
...
func (x *SingleTransaction) GetBlockNumber() int64 {
	if x != nil {
...
func (x *SingleTransaction) GetTransactionIndex() int64 {
	if x != nil {
...
func (x *SingleTransaction) GetIndexedAt() int64 {
	if x != nil {
		return x.IndexedAt
	}
	return 0
...
func (x *SingleTransaction) GetBlockTimestamp() int64 {
	if x != nil {
...
type Block struct {
	...
	IndexedAt        int64                `protobuf:"varint,19,opt,name=indexed_at,json=indexedAt,proto3" json:"indexed_at,omitempty"` // using int64 to represent timestamp
...
func (x *Block) GetIndexedAt() int64 {
	if x != nil {
		return x.IndexedAt
	}
	return 0
...
type EventLog struct {
	...
	BlockNumber      int64    `protobuf:"varint,4,opt,name=block_number,json=blockNumber,proto3" json:"block_number,omitempty"`                // The block number where this log was in
	...
	LogIndex         int64    `protobuf:"varint,8,opt,name=log_index,json=logIndex,proto3" json:"log_index,omitempty"`                         // The index of the log in the block
	TransactionIndex int64    `protobuf:"varint,9,opt,name=transaction_index,json=transactionIndex,proto3" json:"transaction_index,omitempty"` // The index of the transaction in the block
}
...
func (x *EventLog) GetLogIndex() int64 {
	if x != nil {
		return x.LogIndex
	}
	return 0
...
func (x *EventLog) GetTransactionIndex() int64 {
	if x != nil {
		return x.TransactionIndex
	}
	return 0
...
var file_blocks_transactions_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x18, 0x0e, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x65, 0x64, 0x41,
	0x74, 0x12, 0x27, 0x0a, 0x0f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73,
	0x74, 0x61, 0x6d, 0x70, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x62, 0x6c, 0x6f, 0x63,
	...
	0x63, 0x75, 0x6c, 0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x64, 0x69, 0x66,
	...
	0x6d, 0x69, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x67, 0x61, 0x73, 0x4c, 0x69,
	0x6d, 0x69, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x61, 0x73, 0x5f, 0x75, 0x73, 0x65, 0x64, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x67, 0x61, 0x73, 0x55, 0x73, 0x65, 0x64, 0x12, 0x27,
	...
	0x6e, 0x64, 0x65, 0x78, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x13, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x6e, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x42, 0x0e, 0x5a, 0x0c, 0x2e, 0x2f, 0x62, 0x6c, 0x6f, 0x63,
