...
type BlockchainClient interface {
	...
	DecodeProtoEntireBlockToLabels(*bytes.Buffer, map[string]map[string]*indexer.AbiEntry, int) ([]indexer.EventLabel, []indexer.TransactionLabel, []indexer.RawTransaction, error)
