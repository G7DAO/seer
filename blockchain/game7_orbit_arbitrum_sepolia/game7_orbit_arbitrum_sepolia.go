...
func (c *Client) ParseBlocksAndTransactions(from, to *big.Int, debug bool, maxRequests int) ([]*Game7OrbitArbitrumSepoliaBlock, []*Game7OrbitArbitrumSepoliaTransaction, error) {
