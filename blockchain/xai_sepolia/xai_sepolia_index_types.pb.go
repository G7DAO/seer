...
type XaiSepoliaBlockBatch struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *XaiSepoliaBlockBatch) Reset() {
	*x = XaiSepoliaBlockBatch{}
	if protoimpl.UnsafeEnabled {
...
func (x *XaiSepoliaBlockBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*XaiSepoliaBlockBatch) ProtoMessage() {}

func (x *XaiSepoliaBlockBatch) ProtoReflect() protoreflect.Message {
	mi := &file_blockchain_xai_sepolia_xai_sepolia_index_types_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use XaiSepoliaBlockBatch.ProtoReflect.Descriptor instead.
func (*XaiSepoliaBlockBatch) Descriptor() ([]byte, []int) {
	return file_blockchain_xai_sepolia_xai_sepolia_index_types_proto_rawDescGZIP(), []int{4}
}

func (x *XaiSepoliaBlockBatch) GetBlocks() []*XaiSepoliaBlock {
	if x != nil {
		return x.Blocks
	}
	return nil
...
var file_blockchain_xai_sepolia_xai_sepolia_index_types_proto_rawDesc = []byte{
	...
	,
}
...
var file_blockchain_xai_sepolia_xai_sepolia_index_types_proto_goTypes = []any{
	...
	(*XaiSepoliaBlockBatch)(nil),            // 4: XaiSepoliaBlockBatch
}
var file_blockchain_xai_sepolia_xai_sepolia_index_types_proto_depIdxs = []int32{
	...
	2, // 3: XaiSepoliaBlockBatch.blocks:type_name -> XaiSepoliaBlock
...
func file_blockchain_xai_sepolia_xai_sepolia_index_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_blockchain_xai_sepolia_xai_sepolia_index_types_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*XaiSepoliaBlockBatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
