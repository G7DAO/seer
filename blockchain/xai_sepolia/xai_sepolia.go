...
func (c *Client) ParseBlocksAndTransactions(from, to *big.Int) ([]*XaiSepoliaBlock, []*XaiSepoliaTransaction, error) {
...
func (c *Client) ParseEvents(from, to *big.Int, blocksCache map[uint64]indexer.BlockCache) ([]*XaiSepoliaEventLog, error) {
