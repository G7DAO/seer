...
func (x *XaiBlockBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*XaiBlockBatch) ProtoMessage() {}

func (x *XaiBlockBatch) ProtoReflect() protoreflect.Message {
	mi := &file_blockchain_xai_xai_index_types_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use XaiBlockBatch.ProtoReflect.Descriptor instead.
func (*XaiBlockBatch) Descriptor() ([]byte, []int) {
	return file_blockchain_xai_xai_index_types_proto_rawDescGZIP(), []int{4}
}

func (x *XaiBlockBatch) GetBlocks() []*XaiBlock {
	if x != nil {
		return x.Blocks
	}
	return nil
...
var file_blockchain_xai_xai_index_types_proto_rawDesc = []byte{
	...
	0x78, 0x22, 0x32, 0x0a, 0x0d, 0x58, 0x61, 0x69, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x42, 0x61, 0x74,
	0x63, 0x68, 0x12, 0x21, 0x0a, 0x06, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x09, 0x2e, 0x58, 0x61, 0x69, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x06, 0x62,
	0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	...
	0x6e, 0x2f, 0x78, 0x61, 0x69, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_blockchain_xai_xai_index_types_proto_goTypes = []interface{}{
	...
	(*XaiBlockBatch)(nil),            // 4: XaiBlockBatch
}
var file_blockchain_xai_xai_index_types_proto_depIdxs = []int32{
	...
	2, // 3: XaiBlockBatch.blocks:type_name -> XaiBlock
...
func file_blockchain_xai_xai_index_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_blockchain_xai_xai_index_types_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*XaiBlockBatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
