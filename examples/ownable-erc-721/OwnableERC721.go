...
func CreateOwnableERC721DeploymentCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			deployCalldata, err := generateOwnableERC721DeployBytecode(
				name_0,
				symbol,
				owner,
			)
			...
			if verify {
				compilerInfo, err := ExtractCompilerInfo(OwnableERC721Bin)
				if err != nil {
				...
				err = VerifyContractCode(address, OwnableERC721ContractCode, apiURL, apiKey, "OwnableERC721", compilerInfo.SolidityVersion, runs, compilerInfo.EVMVersion, name_0, symbol, owner)
				if err != nil {
...
func CreateSafeTransferFrom0Command() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		PreRunE: func(cmd *cobra.Command, args []string) error {
			...
			data = make([]byte, len(dataIntermediate))
...
func VerifyContractCodeCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return VerifyContractCode(contractAddress, OwnableERC721ContractCode, apiURL, apiKey, "OwnableERC721", compilerInfo.SolidityVersion, runs, compilerInfo.EVMVersion, name_0, symbol, owner)
		},
	}
...
const OwnableERC721ContractCode = ``
